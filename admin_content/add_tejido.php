      ...
      try {
         ...
         if($insert_tejido->rowCount() > 0){ 
            ...
            if($status == 'draft'){
               ...
               header('Location: view_tejido.php'); // Redirect to drafts page
               exit();
            } else {
...
<section class="add-tejido">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="input-box">
         ...
         <input type="file" name="image" id="image" class="box" accept="image/jpg, image/jpeg, image/png, image/gif, image/webp" required>
      </div>
...
<section class="tejido-posts">
   ...
   <div class="box-container">
      ...
      <?php else: ?>
         ...
         if ($any_tejido > 0) {
            echo '<p class="empty">You have ' . $any_tejido . ' tejido posts, but they might be saved as drafts. <a href="view_tejido.php" class="btn" style="margin-top:1.5rem;">View Drafts</a></p>';
         } else {
