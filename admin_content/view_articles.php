...
<section class="tejido-posts">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="flex-btn">
            <a href="edit_article.php?article_id=<?= $article_id; ?>" class="option-btn">Edit</a>
            
            <form action="" method="post" style="display:inline;">
               <input type="hidden" name="article_id" value="<?= $article_id; ?>">
               <button type="submit" name="publish_article" class="btn">Publish</button>
            </form>
      ...
      <?php 
         ...
         echo '<p class="empty">No draft articles found! <a href="add_articles.php" class="btn" style="margin-top:1.5rem;">Add New Article</a></p>';
      }
      ?>
   </div>
</section>
